  ...
  return (
	...
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        ...
        <img className="object-contain" src={logo} alt="Logo" />
				...
				<span className="self-center text-2xl font-semibold">Selva Verde Tours</span>
			</a>
		</div>
		<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-3">
			<div className="space-y-3">
				...
				<ul className="space-y-1">
					<li>
						<p>Calle Juana Arteaga</p>
					</li>
					<li>
						<p>Diagonal al Parque Central</p>
					</li>
					<li>
						<p>Tena, Napo</p>
					</li>
			...
			<div className="space-y-3 s:w-full">
				...
				<div className="flex justify-start space-x-3">
					...
					<a target="_blank" href="#" title="Twitter" className="flex items-center p-1">
	...
	<div className="py-6 text-sm text-center text-coolGray-600">© 2021 by Selvaverde Tours S.A. All rights reserved.</div>
</footer>
  )
}
